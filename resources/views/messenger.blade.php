                                        ...
                                        <div class="col-12 col-xl-6">
                                            <div class="row align-items-center gx-5">
                                                ...
                                                <div class="col overflow-hidden">
                                                    ...
                                                    <p class="text-truncate" d-none></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Title -->
                       ...
                       @csrf
                        <input type="hidden" name="conversation_id" value="{{$activechat->id}}">
                                <div class="row align-items-center gx-0">
                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            <textarea name="body" class="form-control px-0" placeholder="Type your message..." rows="1" data-emoji-input="" data-autosize="true"></textarea>
